...
const required = [
  ...
  'src/lib/print-toc.js', 'src/lib/project-backup.js', 'src/lib/readiness-model.js', 'public/vendor/jszip.min.js',
...
for (const dynamicBinding of ['[data-go-view]','[data-open-project]','[data-delete-project]','[data-nav-page]','[data-ebook-section]','[data-repair-block]','[data-apply-theme]','[data-export-theme]','[data-delete-theme]']) {
