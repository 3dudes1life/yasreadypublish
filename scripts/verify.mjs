...
const required = [
  ...
  'src/lib/editions.js', 'src/lib/proof-integrity.js', 'src/lib/presentation-overrides.js', 'src/lib/kindle-preview-model.js', 'public/vendor/jszip.min.js',
...
for (const marker of ["const VERSION = '1.0.9'", 'Run Final Check', 'Download Project Backup', 'Kindle / eBook', 'Download KDP EPUB', 'Amazon KDP · Reflowable EPUB 3', 'Kindle Preview Studio', 'Adjust Layout', 'kindlePreviewDevice', 'Structure Repair', 'generated-toc-entry', 'One Story Lock · separate outputs', 'bodyBlankPolicy']) {
...
for (const dynamicBinding of ['[data-go-view]','[data-open-project]','[data-delete-project]','[data-nav-page]','[data-ebook-section]','[data-repair-block]','[data-apply-theme]','[data-export-theme]','[data-delete-theme]','[data-edition-enabled]','[data-work-edition]','[data-kindle-mode]']) {
...
if (!project.includes("appVersion: '1.0.9'") || !project.includes('version: 19') || !project.includes('ensureEditions(project)') || !project.includes('ensurePresentationOverrides(project)')) {
  throw new Error('Project schema was not migrated to 1.0.9 Kindle simulator safety state.');
}
...
console.log('YasReady Publish v1.0.9 static verification passed.');
