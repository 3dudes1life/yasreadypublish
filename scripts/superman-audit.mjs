...
const messagePaginationV150 = readFileSync(join(ROOT, 'src/lib/message-pagination.js'), 'utf8');
for (const marker of ['MESSAGE_PAGINATION_VERSION = 1','structuredMessageSegments','isStructuredMessageTranscript']) if (!messagePaginationV150.includes(marker)) throw new Error(`Missing v1.0.50 message pagination marker: ${marker}`);
