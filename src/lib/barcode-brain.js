...
// Amazon/KDP places its retail barcode in a 2 × 1.2 in white box.
// YasReady reserves that exact footprint — never a larger visible knockout —
// so Amazon's printed barcode covers the reserve without leftover white space.
export const KDP_BARCODE_KNOCKOUT_WIDTH_IN = KDP_BARCODE_WIDTH_IN;
export const KDP_BARCODE_KNOCKOUT_HEIGHT_IN = KDP_BARCODE_HEIGHT_IN;
