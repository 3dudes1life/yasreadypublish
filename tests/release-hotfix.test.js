...
test('1.0.1 migrates the old Tres Amigos paragraph gap and Contents parity without touching manuscript text', () => {
  const project = {
    version: 10,
    appVersion: '1.0.0',
  ...
  assert.equal(project.appVersion, '1.0.1');
...
test('1.0.1 preserves a deliberately customized paragraph gap', () => {
  const project = {
    version: 10,
    appVersion: '1.0.0',
