...
test('1.0.2 retains 1.0.1 migration and the old Tres Amigos paragraph gap and Contents parity without touching manuscript text', () => {
  const project = {
    version: 10,
    appVersion: '1.0.0',
...
test('1.0.2 preserves a deliberately customized paragraph gap', () => {
  const project = {
    version: 10,
    appVersion: '1.0.0',
