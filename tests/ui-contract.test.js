...
const requiredBindings = [
  ...
  'prevChapter','nextChapter','libraryImport','copyPaperbackToHardcover'
];
...
test('1.0 sidebar views all route through renderMain', () => {
  for (const view of ['import','chapters','matter','repair','editions','navigator','design','print','export','ebook','source','library']) {
